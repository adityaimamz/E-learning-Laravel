                                                        ...
                                                        <tbody>
                                                            @foreach ($kelas->User as $key)
                                                                @php
                                                                    ...
                                                                    $userTugas = $key->UserJawaban->where('essay_id', $soal->id)->first();
                                                                    $submition = App\Models\UserJawaban::where('user_id', $key->id)
                                                ...
                                                <table id="table" class="table table-striped table-hover table-lg ">
                                                    ...
                                                    <tbody>
                                                        @foreach ($kelas->User as $key)
                                                            @php
                                                                // Mencari UserTugas sesuai dengan ID tugas yang Anda inginkan
                                                                $userTugas = $key->UserJawaban->where('multiple_id', $soal->id)->first();
                                                                $submition = App\Models\UserJawaban::where('user_id', $key->id)
