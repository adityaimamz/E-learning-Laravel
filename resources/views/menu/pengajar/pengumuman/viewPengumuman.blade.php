    ...
    <div class="col-12 ps-4 pe-4 mb-4">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-12 col-md-12">
                ...
                {{-- <div class="mb-4 p-4 bg-white rounded-4">
                    <div class="h-100 p-4">
                        <h4 class="fw-bold mb-2">List Pengumuman</h4>
                        <hr>
                        <ul class="list-group">
                            @foreach ($pengumumanAll as $key)
                                @if ($key->isHidden != 1 || Auth()->User()->roles_id == 2)
                                    @if ($pengumuman['id'] != $key->id)
                                        <a
                                            href="{{ route('viewPengumuman', ['token' => encrypt($key->id), 'kelasMapelId' => encrypt($pengumuman['kelas_mapel_id']), 'mapelId' => $mapel['id']]) }}">
                                    @endif
                                    <li class="list-group-item  @if ($pengumuman['id'] == $key->id) active @endif">
                ...
                {{-- <div class="mb-4 p-4 bg-white rounded-4">
                    <div class="h-100 p-4">
                        ...
                        <hr>
                        @if (count($pengumuman->PengumumanFile) > 0)
                            <ul class="list-group">
                                @foreach ($pengumuman->PengumumanFile as $key)
                                ...
                                @endforeach
                            @else
                                <span class="small">(Tidak ada file untuk pengumuman ini)</span>
                        @endif
