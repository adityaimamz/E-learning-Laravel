...
@section('container')
    ...
    <div class="col-12 ps-4 pe-4 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item active" aria-current="page">Update Rekomendasi</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="ps-4 pe-4 mt-4  pt-4">
        <h2 class="display-6 fw-bold">
            ...
            </a> Update Rekomendasi
        </h2>
    </div>

    {{-- Formulir Update Rekomendasi --}}
    <div class="">
        <div class="row p-4">
            <h4 class="fw-bold text-primary"><i class="fa-solid fa-pen"></i> Data Rekomendasi</h4>
            <div class="col-12 col-lg-12 bg-white rounded-2">
                <div class="mt-4">
                    <div class="p-4">
                        <form action="{{ route('updateRekomendasi') }}" id="form-main" method="GET"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-4 col-lg form-check form-switch">
                                    <input class="form-check-input" name="opened" type="checkbox" role="switch"
                                        id="opened" @if ($rekomendasi->isHidden == 0) checked @endif>
                                </div>
                            </div>
                            {{-- Nama Rekomendasi --}}
                            <div class="mb-3">
                                <label for="nama" class="form-label">Judul Rekomendasi</label>
                                <input type="hidden" name="kelasId" value="{{ encrypt($kelasId) }}" readonly>
                                <input type="hidden" name="rekomendasiId" value="{{ encrypt($rekomendasi['id']) }}" readonly>
                                <input type="hidden" name="mapelId" value="{{ $mapel['id'] }}" readonly>
                                <input type="text" class="form-control" id="nama" name="name"
                                    placeholder="Inputkan judul rekomendasi..." value="{{ old('name', $rekomendasi['name']) }}"
                                    required>
                                @error('name')
        ...
        <div class="col-12 col-lg-12 bg-white rounded-2">
            <div the="mt-4">
                <div class="p-4">
                    ...
                    <hr>
                    <div class="row ">
                        @foreach ($rekomendasi->RekomendasiFile as $key)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('destroyFileRekomendasi') }}" method="post">
                        @csrf
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                        <input type="hidden" name="idRekomendasi" id="idRekomendasi" value="{{ $rekomendasi['id'] }}">
...
<script src="https://cdn.tiny.cloud/1/27rm72jiv3he0rix00xvw5nmcz0yd4rko98rj2p8pcrh4wlv/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>;
    ...
    <script>
        ...
        Dropzone.autoDiscover = false; // Untuk menghindari Dropzone menginisialisasi dirinya sendii secara otomatis
        ...
        var myDropzone = new Dropzone("#my-dropzone", {
            url: "{{ route('uploadFileRekomendasi') }}" + "?action=edit&idRekomendasi=" +
                "{{ $rekomendasi['id'] }}", // Ganti dengan rute yang sesuai untuk menangani unggahan file
