    ...
    <div class="col-12 ps-4 pe-4 mb-4">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-12 col-md-12">
                ...
                {{-- <div class="mb-4 p-4 bg-white rounded-4">
                    <div class="h-100 p-4">
                        <h4 class="fw-bold mb-2">List Rekomendasi</h4>
                        <hr>
                        <ul class="list-group">
                            @foreach ($rekomendasiAll as $key)
                                @if ($key->isHidden != 1 || Auth()->User()->roles_id == 2)
                                    @if ($rekomendasi['id'] != $key->id)
                                        <a
                                            href="{{ route('viewRekomendasi', ['token' => encrypt($key->id), 'kelasMapelId' => encrypt($rekomendasi['kelas_mapel_id']), 'mapelId' => $mapel['id']]) }}">
                                    @endif
                                    <li class="list-group-item  @if ($rekomendasi['id'] == $key->id) active @endif">
                ...
                {{-- <div class="mb-4 p-4 bg-white rounded-4">
                    <div class="h-100 p-4">
                        ...
                        <hr>
                        @if (count($rekomendasi->RekomendasiFile) > 0)
                            <ul class="list-group">
                                ...
                                @endforeach
                            @else
                                <span class="small">(Tidak ada file untuk rekomendasi ini)</span>
                        @endif
