...
@section('container')
    ...
    <div class="col-12 ps-4 pe-4 mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambah Rekomendasi</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="">
        <div class="row p-4">
            ...
            <div class="col-12 col-lg-12 bg-white rounded-2">
                <div class="mt-4">
                    <div class="p-4">
                        <form action="{{ route('createRekomendasi') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{-- Status Open / Close --}}
                            <div class="mb-3 row">
                            ...
                            {{-- Nama Rekomendasi --}}
                            <div class="mb-3">
                                <label for="name" class="form-label">Judul Rekomendasi</label>
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Inputkan judul rekomendasi..." value="{{ old('name') }}" required>
                                @error('name')
    ...
    <script>
        ...
        var myDropzone = new Dropzone("#my-dropzone", {
            url: "{{ route('uploadFileRekomendasi', ['action' => 'tambah']) }}", // Ganti dengan rute yang sesuai untuk menangani unggahan file
