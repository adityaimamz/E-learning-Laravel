...
Route::controller(RekomendasiController::class)->group(function () {
    ...
    Route::get('/rekomendasi/update/{token}', 'viewUpdateRekomendasi')->middleware('pengajar')->name('viewUpdateRekomendasi');
    Route::post('/store-rekomendasi', 'createRekomendasi')->middleware('pengajar')->name('createRekomendasi');
    Route::post('/update-rekomendasi', 'updateRekomendasi')->middleware('pengajar')->name('updateRekomendasi');
    Route::post('/destroy-rekomendasi', 'destroyRekomendasi')->middleware('pengajar')->name('destroyRekomendasi');

    Route::get('/rekomendasi', 'viewRekomendasi')->middleware('auth')->name('viewRekomendasi');

    Route::post('/upload-rekomendasi-file', 'uploadFileRekomendasi')->middleware('auth')->name('uploadFileRekomendasi');
    Route::post('/destroy-rekomendasi-file', 'destroyFileRekomendasi')->middleware('auth')->name('destroyFileRekomendasi');
    Route::get('/redirect-after', 'redirectBack')->middleware('auth')->name('redirectBack');
});
